...
p <- file.path('.',  'spatial_lecture_data', 'Chicago_Park_District_Park_Boundaries')
files <- file.path(p, list.files(p, ".shp"))
...
knitr::include_graphics(file.path('.','pictures', 'DE-9IM_By_Krauss.png'))
```
...
knitr::include_graphics(file.path('.', 'pictures', 'Great_Circle_Distance_CheCheDaWaff.png'))
```
:::
